...
const initBeatList = () => {
    ...
    beat_list[TWISTING] = [
        ...
        new AiBeat(
            ...
            [`${SUBJECTSTRING} begins clutching their head and roaring in pain. You see murder in their eyes as they desperately try to parse what they are seeing in this terrible, terrible room.`],
            [new TargetStabilityLevelLessThanAmount(0, { invert: true, singleTarget: true, kMode: true }), new TargetHighestStatIsX(FORTITUDE)], //don't go if you're already unstable
            [new ChangeMyStabilityLevelByAmount(-13)],
            true,
            1000 * 30),
        ...
        new AiBeat(
            `${SUBJECTSTRING}: Degrade Stability`,
            [`${SUBJECTSTRING} begins clutching their head and whimpering in pain. They desperately try to flee the twisting spiralling chaos they are seeing in this terrible, terrible room.`],
