...
export class ApocalypseEngine {
    ...
    init = () => {
        ...
        this.minigame = new TypingMiniGame(this.terminal,"True confessions of a Doctor. Please Listen. I am. Trying. The 12 Call To Me. The Sins Must Be Clensed. I do not Know how much Longer I can Hold Out. L-0-17 was right.", this.handleCallback);
